...
syn match 	_cppClass	display "::\w\+"ms=s+2
syn match 	_cppClassT	display "::\w\+<\w\+>"ms=s+2
syn match 	cppClassT_	display "\w\+<\w\+>::"me=e-2
syn match 	cppClass_	display "\w\+::"me=e-2
syn match	cppFct		display "\w\+\s*("me=e-1
...
if version >= 508 || !exists("did_cpp_syntax_inits")
  ...
  HiLink cppFct			Function
  HiLink _cppClassT		Type
  HiLink _cppClass		Type
  HiLink cppClass_		Class
  HiLink cppClassT_		Class
  HiLink cppType		Type
