...
syn match	cTypedef	display "\<t_[a-z][a-z0-9_]*\>"
syn match	cTypedef	display "\<i_[a-z][a-z0-9_]*\>"
syn match	cTypedef	display "\<m_[a-z][a-z0-9_]*\>"
syn match	cTypedef	display "\<o_[a-z][a-z0-9_]*\>"
syn match	cTypedef	display "\<d_[a-z][a-z0-9_]*\>"
syn match	cUnion		display "\<d_[a-z][a-z0-9_]*\>"
...
syn keyword	cTodo		contained TODO FIXME XXX ??? REMOVEME
syn keyword	cDone		contained FIXED
syn match	cTodo		"\s_\S*_\s"

" cCommentGroup allows adding matches for special things in comments
syn cluster	cCommentGroup	contains=cTodo,cDone
